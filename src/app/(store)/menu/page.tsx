...
const FALLBACK_PRODUCTS: Product[] = [
  {
    ...
    image_url: '/images/products/la-casi-triple.jpg', image: '/images/products/la-casi-triple.jpg', active: true, featured: true, sort_order: 0, sold_out: false, created_at: '', updated_at: '',
  },
  {
    ...
    image_url: '/images/products/la-primera-cita.png', image: '/images/products/la-primera-cita.png', active: true, featured: false, sort_order: 1, sold_out: false, created_at: '', updated_at: '',
  },
  {
    ...
    image_url: '/images/products/box-mini-monster.png', image: '/images/products/box-mini-monster.png', active: true, featured: true, sort_order: 0, sold_out: false, created_at: '', updated_at: '',
  },
  {
    ...
    image_url: '/images/products/amarre-arabe.png', image: '/images/products/amarre-arabe.png', active: true, featured: false, sort_order: 0, sold_out: false, created_at: '', updated_at: '',
  },
  {
    ...
    image_url: '/images/products/chikiturri.png', image: '/images/products/chikiturri.png', active: true, featured: false, sort_order: 0, sold_out: false, created_at: '', updated_at: '',
  },
  {
    ...
    image_url: '/images/products/chikiturri.png', image: '/images/products/chikiturri.png', active: true, featured: false, sort_order: 1, sold_out: false, created_at: '', updated_at: '',
  },
  {
    ...
    image_url: '/images/products/empanada-incondicional.png', image: '/images/products/empanada-incondicional.png', active: true, featured: false, sort_order: 0, sold_out: false, created_at: '', updated_at: '',
  },
  {
    ...
    image_url: '/images/products/empanada-incondicional.png', image: '/images/products/empanada-incondicional.png', active: true, featured: false, sort_order: 1, sold_out: false, created_at: '', updated_at: '',
  },
];
...
export default async function MenuPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F3E8CC' }}>
      <div className="pt-6 pb-2 px-4 max-w-5xl mx-auto">
        <h1
